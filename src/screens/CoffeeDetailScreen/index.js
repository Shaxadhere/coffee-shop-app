...
const CoffeeDetailScreen = ({ route, navigation }) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.dark }}>
            <ScrollView>
                <SafeAreaView>
                    <ImageBackground source={coffee.image} style={{
                    ...
                    >
                        <View style={{
                            ...
                            <TouchableOpacity
                                ...
                                <Icon name='arrow-back' color={colors.light} size={SPACING * 2} />
                            </TouchableOpacity>
                            <TouchableOpacity style={{
                                ...
                                <Icon name='heart' color={colors.light} size={SPACING * 2} />
                            </TouchableOpacity>
                        </View>
                        <View style={{
                            borderRadius: SPACING * 3,
                            ...
                            <BlurView
                                ...
                                <View>
                                    <Text style={{ fontSize: SPACING * 2, color: colors.white, fontWeight: "600", marginBottom: SPACING }}>
                                        {coffee.name}
                                    </Text>
                                    <Text style={{ fontSize: SPACING * 1.8, color: colors.whiteSmoke, fontWeight: "500", marginBottom: SPACING }}>
                                        {coffee.included}
                                    </Text>
                                    <View style={{
                                        flexDirection: "row",
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={{ color: colors.whiteSmoke, fontSize: SPACING * 1.3 }}>Coffee</Text>
                                        </View>
                                        <View style={{
                                            padding: SPACING / 2,
                                            backgroundColor: colors.dark,
                                            ...
                                            <Text style={{ color: colors.whiteSmoke, fontSize: SPACING * 1.3 }}>Milk</Text>
                                        </View>
                                    </View>
                                    <View style={{
                                        backgroundColor: colors.dark,
                                ...
                                {sizes.map((item, index) =>
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            ...
                                            activeSize === item && { borderColor: colors.primary, backgroundColor: colors.dark }
                                        ]}>
                                        <Text style={[
                                            { color: colors.whiteSmoke, fontSize: SPACING * 1.9 },
                                            activeSize === item && {
            ...
            <SafeAreaView style={{ flexDirection: "row", justifyContent: "space-between" }}>
                ...
                <TouchableOpacity style={{
                    ...
                    <Text style={{
                        color: colors.white, fontSize: SPACING * 2, fontWeight: "700"
                    }}>Buy Now</Text>
                </TouchableOpacity>
            </SafeAreaView>
        </View>
